package com.danan.gd12_pdf_b_10792
...
import com.danan.gd12_pdf_b_10792.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    if (nama.isEmpty() && umur.isEmpty() && tlp.isEmpty() && alamat.isEmpty() && kampus.isEmpty()) {
                        Toast.makeText(
                            applicationContext,"Semuanya Tidak boleh Kosong",Toast.LENGTH_SHORT).show()
                    } else {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10792.pdf")
        ...
        @SuppressLint("UseCompactLoadingForDrawables") val d = getDrawable(R.drawable.glden)
